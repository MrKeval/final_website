...
$ret=mysqli_query($con,"SELECT month(date) as rptmonth,year(date) as rptyear,SUM(amount) as totalmonth FROM expense_master  where (date BETWEEN '$fdate' and '$tdate') && (user_id='$userid') group by month(date),year(date)");
$cnt=1;
