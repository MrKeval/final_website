...
// $query=mysqli_query($con, "select * from category_master where cate_name='$cate'");
...
$query=mysqli_query($con, "insert into budget_master (user_id,cate_id,amount,start_date,end_date) value('$userid','$cate_id','$amount','$sdate','$edate')");
if($query){
