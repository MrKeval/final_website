    ...
    echo $msg;
                        ...
                        if(isset($_GET['updateid']))
                        {
	                        $rowid=intval($_GET['updateid']);
                             ...
                             $userid=$_SESSION['detsuid'];
                             $ret=mysqli_query($con,"SELECT expense_master.amount, expense_master.expense_de,expense_master.date,expense_master.pay_mode, category_master.cate_name
                        ...
                        ?>
							...
							<div class="form-group">
								...
								<select name="category">
                                    ...
                                    <!-- <option value="">Select Course</optio> -->
									<?php
