...
if(isset($_POST['submit']))
  {
    ...
    $ret=mysqli_query($con, "select email_id from user_master where email_id='$email' ");
    $result=mysqli_fetch_array($ret);
    if($result>0){
$msg="This email  associated with another account";
    }
    else{
    $query=mysqli_query($con, "insert into user_master(user_name, email_id,mobile_no, password) value('$uname', '$email','$mobno', '$password' )");
    ...
    echo $msg;
						...
						<fieldset>
							<div class="form-group">
								<input class="form-control" placeholder="user_name" name="username" type="text" required="true">
							</div>
							<div class="form-group">
