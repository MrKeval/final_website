...
$ret=mysqli_query($con,"SELECT year(date) as rptyear,SUM(amount) as totalyear FROM expense_master  where (date BETWEEN '$fdate' and '$tdate') && (user_id='$userid') group by year(date)");
$cnt=1;
